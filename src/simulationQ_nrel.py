...
if __name__ == '__main__':
    tests={"nrel_Q":{"T":args.T,"A":0.001,"G":0.0,"reps":args.reps,"params":{"N":args.Ns,"n1":[0],"n2":args.n2s,"thresh":[args.thresh]}
                     ,"meas_fct":MeasurementGenNREL,"dec_fct_sup":DecisionLogicSupervisorW,"dec_fct":DecisionLogicDQ,"rew_fct":RewardLogicUniform}}
