...
if __name__ == '__main__':
    tests={"ev_knap":{"T":args.T,"A":0.001,"G":0.0,"reps":args.reps,"params":{"N":args.Ns,"n1":[0],"n2":args.n2s,"thresh":[args.thresh]}
                      ,"meas_fct":MeasurementGenEV,"dec_fct_sup":DecisionLogicSupervisorKnapsack,"dec_fct":DecisionLogicEmpty,"rew_fct":RewardLogicUniform},
           "ev_mand":{"T":args.T,"A":0.001,"G":0.0,"reps":args.reps,"params":{"N":args.Ns,"n1":[0],"n2":args.n2s,"thresh":[args.thresh]}
                      ,"meas_fct":MeasurementGenEV,"dec_fct_sup":DecisionLogicSupervisorMandatory,"dec_fct":DecisionLogicEmpty,"rew_fct":RewardLogicUniform}}
