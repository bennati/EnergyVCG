...
if __name__ == '__main__':
    tests={"nrel_rand":{"T":args.T,"A":0.001,"G":0.0,"reps":args.reps,"params":{"N":args.Ns,"n1":[0],"n2":args.n2s,"thresh":[args.thresh]}
                    ,"meas_fct":MeasurementGenNREL,"dec_fct_sup":DecisionLogicSupervisorRandom,"dec_fct":DecisionLogicEmpty,"rew_fct":RewardLogicUniform}}
